# Complete OpenAI Functions Source Code
...
## Core Function: `callOpenAI` (lines 17-153)
...
## Function 1: `generateATSFeedback` (lines 186-253)
...
## Function 2: `generateResumeRewrite` (lines 263-293)
...
## Helper Functions (used by `callOpenAI`)
...
### Dependencies
- **No external imports** - This is a standalone module
- **Uses Cloudflare Workers APIs**: `fetch`, `env.JOBHACKAI_KV`
- **Exports**: `callOpenAI`, `generateATSFeedback`, `generateResumeRewrite`, `moderateContent`

### Current Configuration

| Function | Model | Max Tokens | Temperature | Structured Output |
|----------|-------|------------|-------------|-------------------|
| `generateATSFeedback` | `gpt-4o-mini` | 800 | 0.2 | ✅ Yes |
| `generateResumeRewrite` | `gpt-4o` | 2000 | 0.2 | ❌ No |
