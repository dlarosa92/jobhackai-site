...
export async function onRequest(context) {
  ...
  try {
    ...
    try {
      ...
      console.log('🟡 [CHECKOUT] Failed to list subscriptions (non-fatal)', subsErr?.message || subsErr);
      // Treat Stripe errors as "no subscriptions found" to allow checkout to proceed
    }
