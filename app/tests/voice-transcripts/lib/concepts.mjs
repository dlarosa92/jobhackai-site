...
export const CONCEPTS = {
  ...
  // NOTE: "tangent" and "stay focused" deliberately excluded — trimming
  // tangents and staying focused are conciseness coaching for rambling
  // answers, not relevance verdicts.
  'relevance-concern': [
