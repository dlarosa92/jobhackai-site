...
(function() {
  ...
  const qaHosts = ['qa.jobhackai.io', 'qa-marketing.jobhackai.io', 'directory-qa.jobhackai-app-marketing-seo.pages.dev'];
  ...
  const COOKIE_DOMAIN = hostname.endsWith('.jobhackai.io') || hostname === 'jobhackai.io' ? '; Domain=.jobhackai.io' : '';
  ...
  function loadGAScript() {
    ...
    gtag('config', GA_MEASUREMENT_ID, {
      ...
      cookie_domain: hostname.endsWith('.jobhackai.io') || hostname === 'jobhackai.io' ? 'jobhackai.io' : hostname,
