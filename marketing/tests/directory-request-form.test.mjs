...
test('unrecognized previews cannot write any environment',()=>{
 for(const host of ['branch.jobhackai-app-marketing-seo.pages.dev','evil.example']) assert.equal(setup(host).nodes['request-submit'].disabled,true);
});
