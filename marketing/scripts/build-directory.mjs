...
const shell = (title, description, body, listing = '', canonical = listing ? `/directory/${data.category}/${listing}` : '/directory') => `<!doctype html>
...
<input type="hidden" name="category" value="mobile-detailing">
